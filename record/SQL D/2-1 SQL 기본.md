...
4. 뷰(View) 생성과 삭제
    ...
    - **장점과 단점**
        ...
        | 장점 | 단점 |
        | --- | --- |
        | - 특정 칼럼만 조회할 수 있기 때문에 보안 기능이 있다. <br> - 데이터 관리가 간단하다. <br> - SELECT문이 간단해진다. <br> - 하나의 테이블에 여러 개의 뷰를 생성할 수 있다.
        | - 뷰는 독자적인 인덱스를 만들 수 없다. <br> - 삽입, 수정, 삭제 연산이 제약된다. <br> - 데이터 구조를 변경할 수는 없다. |
